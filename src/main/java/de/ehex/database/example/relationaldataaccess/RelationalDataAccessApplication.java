...
public class RelationalDataAccessApplication implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        jdbcTemplate.execute("CREATE TABLE customers(" +
                "id SERIAL, first_name VARCHAR(255), last_name VARCHAR(255), geburts_datum VARCHAR(255))");

        // Split up the array of whole names into an array of first/last names
        List<Object[]> splitUpNames = Arrays.asList("John Woo 14.03.1984", "Jeff Dean 23.05.1998" , "Josh Bloch 28.7.1988", "Josh Long 08.10.1954").stream()
                .map(name -> name.split(" "))
        ...
        jdbcTemplate.batchUpdate("INSERT INTO customers(first_name, last_name, geburts_datum) VALUES (?,?,?)", splitUpNames);
